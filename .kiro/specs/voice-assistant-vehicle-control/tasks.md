...
- [ ] 1. Project setup and core infrastructure
  - [-] 1.1 Create pyproject.toml with hatchling build, all dependencies, and dev extras
  ...
  - [-] 1.2 Create Docker Compose configuration for Kuksa databroker
  ...
  - [-] 1.3 Create project directory structure and core modules
