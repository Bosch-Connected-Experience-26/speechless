...
- [x] 2. Speech Engine (local STT + cloud fallback)
  ...
  - [x] 2.4 Write property test for confidence threshold cloud fallback
...
- [x] 3. Command Router (keyword classification)
  ...
  - [x] 3.2 Write property test for classification completeness
  ...
  - [x] 3.3 Write property test for routing correctness
...
- [x] 4. Edge Processor (intent parser + vehicle controller + Kuksa gRPC)
  ...
  - [x] 4.3 Write property test for intent parsing
  ...
  - [x] 4.4 Write property test for intent-to-VSS signal mapping
  ...
  - [x] 4.5 Write property test for error messages
  ...
  - [x] 4.6 Write property test for VSS path format validity
  ...
  - [x] 4.7 Write property test for exponential backoff retry timing
...
- [x] 6. Edge LLM Client (OpenAI-compatible, dual targets)
  ...
  - [x] 6.2 Write property test for Edge LLM API contract consistency
...
- [x] 7. Cloud Processor (AWS Bedrock converse API)
  ...
  - [x] 7.2 Write property test for Bedrock message formatting
  ...
  - [x] 7.3 Write property test for Bedrock response extraction
...
- [x] 8. Connectivity Monitor (periodic ping, mode switching)
  ...
  - [x] 8.2 Write property test for offline mode routing
...
- [x] 9. Conversation Context Manager (offline multi-turn history)
  ...
  - [x] 9.2 Write property test for context forwarding on reconnection
  ...
  - [x] 9.3 Write property test for offline conversation accumulation
...
- [x] 12. Route Planner (fuel-aware reachability, multi-constraint routing)
  ...
  - [x] 12.2 Write property test for fuel reachability computation
  ...
  - [x] 12.3 Write property test for route ranking
  ...
  - [x] 12.4 Write property test for route constraint satisfaction
  ...
  - [x] 12.5 Write property test for combined route metadata
...
- [x] 13. Biometric Monitor (heart rate, emergency threshold, auto-routing)
  ...
  - [x] 13.2 Write property test for biometric emergency threshold
  ...
  - [x] 13.3 Write property test for emergency cancellation
...
- [x] 15. Pipeline Orchestrator (wires all components, mode-aware routing, state machine)
  ...
  - [x] 15.2 Write property test for log entry completeness
  ...
  - [x] 15.3 Write property test for error recovery
...
- [x] 17. Integration tests and end-to-end flows
  - [x] 17.1 Write integration tests for speech-to-command pipeline
  ...
  - [x] 17.2 Write integration tests for vehicle control flow
  ...
  - [x] 17.3 Write integration tests for connectivity transitions
  ...
  - [x] 17.4 Write integration tests for route planning and biometric flows
  ...
  - [x] 17.5 Write integration test for demo scenario flow
...
- [x] 18. Architectural documentation
  - [x] 18.1 Create hyperdetailed .drawio architectural diagram
  ...
  - [x] 18.2 Create Mermaid sequence diagrams
  ...
  - [x] 18.3 Create use case diagrams
...
- [x] 19. Demo scenario script
  - [x] 19.1 Create scripted demo scenario (3-5 minutes)
...
- [x] 20. Real-time information query support
  - [x] 20.1 Implement real-time data query support in Cloud Processor
